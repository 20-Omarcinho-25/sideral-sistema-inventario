...
REM --- Verificar que Zod esté instalado ---
echo Verificando dependencia Zod...
cd /d "%REPO%\frontend"
if not exist "node_modules\zod" (
  echo [ADVERTENCIA] Zod no esta instalado. Ejecuta instalar.bat primero.
  pause
  exit /b 1
)
echo [OK] Zod instalado correctamente.
