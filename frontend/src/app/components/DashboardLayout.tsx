...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden font-sans">
      ...
      {/* EL MENÚ LATERAL (SIDEBAR FORZADO) */}
      <aside className="w-64 bg-gray-900 text-white flex flex-col shadow-2xl z-20">
        ...
        <div className="p-4 border-t border-gray-800">
          <button onClick={handleCerrarSesion} className="w-full text-left px-4 py-3 text-red-400 hover:bg-gray-800 rounded-lg transition-colors font-medium">
            Cerrar Sesión
          </button>
        </div>
      </aside>

      {/* EL PANEL DERECHO (DONDE SE DIBUJA TU DASHBOARD) */}
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* CONTENIDO MÁGICO (AQUÍ APARECERÁN TUS CUADROS DE RESUMEN) */}
